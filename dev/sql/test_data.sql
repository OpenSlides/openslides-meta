...
INSERT INTO poll_t (id,title,type,backend,pollmethod,onehundred_percent_base,sequential_number,content_object_id,meeting_id)
    VALUES (1, 'Titel21', 'analog', 'fast', 'YNA', 'disabled', 1, 'topic/1', 1);--rl:gr topic.poll_ids:poll.content_object_id
