...
CREATE TABLE meeting_t (
    ...
    projector_countdown_warning_time integer NOT NULL CONSTRAINT minimum_meeting_projector_countdown_warning_time CHECK (projector_countdown_warning_time >= 0) DEFAULT 0,
...
CREATE TABLE structure_level_list_of_speakers_t (
    ...
    list_of_speakers_id integer NOT NULL,
    initial_time integer NOT NULL CONSTRAINT minimum_structure_level_list_of_speakers_initial_time CHECK (initial_time >= 1),
