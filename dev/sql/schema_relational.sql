...
-- MODELS_YML_CHECKSUM = '38e3ba8ca214cb99d4d28caf140370d7'
...
ALTER TABLE poll_config_option_t ADD CONSTRAINT fk_poll_config_option_t_poll_config_id_poll_config_appro6960976 FOREIGN KEY(poll_config_id_poll_config_approval_id) REFERENCES poll_config_approval_t(id) INITIALLY DEFERRED;
CREATE INDEX idx_poll_config_option_t_poll_config_id_poll_config_approval_id ON poll_config_option_t (poll_config_id_poll_config_approval_id);
ALTER TABLE poll_config_option_t ADD CONSTRAINT fk_poll_config_option_t_poll_config_id_poll_config_selecf8ee498 FOREIGN KEY(poll_config_id_poll_config_selection_id) REFERENCES poll_config_selection_t(id) INITIALLY DEFERRED;
CREATE INDEX idx_poll_config_option_t_poll_config_id_poll_config_selef031df2 ON poll_config_option_t (poll_config_id_poll_config_selection_id);
ALTER TABLE poll_config_option_t ADD CONSTRAINT fk_poll_config_option_t_poll_config_id_poll_config_ratinad2ee64 FOREIGN KEY(poll_config_id_poll_config_rating_score_id) REFERENCES poll_config_rating_score_t(id) INITIALLY DEFERRED;
CREATE INDEX idx_poll_config_option_t_poll_config_id_poll_config_ratia91759a ON poll_config_option_t (poll_config_id_poll_config_rating_score_id);
ALTER TABLE poll_config_option_t ADD CONSTRAINT fk_poll_config_option_t_poll_config_id_poll_config_ratin79bc2a7 FOREIGN KEY(poll_config_id_poll_config_rating_approval_id) REFERENCES poll_config_rating_approval_t(id) INITIALLY DEFERRED;
CREATE INDEX idx_poll_config_option_t_poll_config_id_poll_config_rati9075d6e ON poll_config_option_t (poll_config_id_poll_config_rating_approval_id);
ALTER TABLE poll_config_option_t ADD CONSTRAINT fk_poll_config_option_t_poll_config_id_poll_config_stv_s66764cc FOREIGN KEY(poll_config_id_poll_config_stv_scottish_id) REFERENCES poll_config_stv_scottish_t(id) INITIALLY DEFERRED;
CREATE INDEX idx_poll_config_option_t_poll_config_id_poll_config_stv_83d6519 ON poll_config_option_t (poll_config_id_poll_config_stv_scottish_id);
ALTER TABLE poll_config_option_t ADD CONSTRAINT fk_poll_config_option_t_meeting_user_id_meeting_user_t_id FOREIGN KEY(meeting_user_id) REFERENCES meeting_user_t(id) INITIALLY DEFERRED;
CREATE INDEX idx_poll_config_option_t_meeting_user_id ON poll_config_option_t (meeting_user_id);
...
FOR EACH ROW EXECUTE FUNCTION log_modified_related_models('poll_config_approval','poll_config_id_poll_config_approval_id','option_ids');
...
FOR EACH ROW EXECUTE FUNCTION log_modified_related_models('poll_config_selection','poll_config_id_poll_config_selection_id','option_ids');
...
FOR EACH ROW EXECUTE FUNCTION log_modified_related_models('poll_config_rating_score','poll_config_id_poll_config_rating_score_id','option_ids');
...
FOR EACH ROW EXECUTE FUNCTION log_modified_related_models('poll_config_rating_approval','poll_config_id_poll_config_rating_approval_id','option_ids');
...
FOR EACH ROW EXECUTE FUNCTION log_modified_related_models('poll_config_stv_scottish','poll_config_id_poll_config_stv_scottish_id','option_ids');
