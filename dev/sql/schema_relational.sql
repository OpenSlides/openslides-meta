...
-- MODELS_YML_CHECKSUM = '7b13c3d504f6fb9aa5d52140553bac66'
...
CREATE TABLE poll_t (
    ...
    description text,
    title varchar(256) NOT NULL,
    visibility varchar(256) NOT NULL CONSTRAINT enum_poll_visibility CHECK (visibility IN ('analog', 'named', 'open', 'secret')),
