...
CREATE TABLE assignment_t (
    ...
    description text,
    open_posts integer CONSTRAINT minimum_assignment_open_posts CHECK (open_posts >= 0) DEFAULT 0,
...
CREATE TABLE committee_t (
    ...
    parent_id integer,
    organization_id integer CONSTRAINT required_committee_organization_id NOT NULL DEFAULT 1
);
...
CREATE TABLE gender_t (
    ...
    organization_id integer CONSTRAINT required_gender_organization_id NOT NULL DEFAULT 1
);
...
CREATE TABLE meeting_t (
    ...
    name varchar(200) CONSTRAINT required_meeting_name NOT NULL DEFAULT 'OpenSlides',
    ...
    applause_min_amount integer CONSTRAINT minimum_meeting_applause_min_amount CHECK (applause_min_amount >= 0) DEFAULT 1,
    applause_max_amount integer CONSTRAINT minimum_meeting_applause_max_amount CHECK (applause_max_amount >= 0) DEFAULT 0,
    applause_timeout integer CONSTRAINT minimum_meeting_applause_timeout CHECK (applause_timeout >= 0) DEFAULT 5,
    applause_particle_image_url varchar(256),
    projector_countdown_default_time integer CONSTRAINT required_meeting_projector_countdown_default_time NOT NULL DEFAULT 60,
    projector_countdown_warning_time integer CONSTRAINT required_meeting_projector_countdown_warning_time NOT NULL CONSTRAINT minimum_meeting_projector_countdown_warning_time CHECK (projector_countdown_warning_time >= 0) DEFAULT 0,
    ...
    export_pdf_line_height double precision CONSTRAINT minimum_meeting_export_pdf_line_height CHECK (export_pdf_line_height >= 1.0) DEFAULT 1.25,
    export_pdf_page_margin_left integer CONSTRAINT minimum_meeting_export_pdf_page_margin_left CHECK (export_pdf_page_margin_left >= 0) DEFAULT 20,
    export_pdf_page_margin_top integer CONSTRAINT minimum_meeting_export_pdf_page_margin_top CHECK (export_pdf_page_margin_top >= 0) DEFAULT 25,
    export_pdf_page_margin_right integer CONSTRAINT minimum_meeting_export_pdf_page_margin_right CHECK (export_pdf_page_margin_right >= 0) DEFAULT 20,
    export_pdf_page_margin_bottom integer CONSTRAINT minimum_meeting_export_pdf_page_margin_bottom CHECK (export_pdf_page_margin_bottom >= 0) DEFAULT 20,
    ...
    list_of_speakers_amount_last_on_projector integer CONSTRAINT minimum_meeting_list_of_speakers_amount_last_on_projector CHECK (list_of_speakers_amount_last_on_projector >= -1) DEFAULT 0,
    list_of_speakers_amount_next_on_projector integer CONSTRAINT minimum_meeting_list_of_speakers_amount_next_on_projector CHECK (list_of_speakers_amount_next_on_projector >= -1) DEFAULT -1,
    ...
    motions_line_length integer CONSTRAINT minimum_meeting_motions_line_length CHECK (motions_line_length >= 40) DEFAULT 85,
    ...
    motions_supporters_min_amount integer CONSTRAINT minimum_meeting_motions_supporters_min_amount CHECK (motions_supporters_min_amount >= 0) DEFAULT 0,
    ...
    motion_poll_projection_name_order_first varchar(256) CONSTRAINT required_meeting_motion_poll_projection_name_order_first NOT NULL CONSTRAINT enum_meeting_motion_poll_projection_name_order_first CHECK (motion_poll_projection_name_order_first IN ('first_name', 'last_name')) DEFAULT 'last_name',
    motion_poll_projection_max_columns integer CONSTRAINT required_meeting_motion_poll_projection_max_columns NOT NULL DEFAULT 6,
...
CREATE TABLE motion_t (
    ...
    start_line_number integer CONSTRAINT minimum_motion_start_line_number CHECK (start_line_number >= 1) DEFAULT 1,
...
CREATE TABLE motion_state_t (
    ...
    is_internal boolean,
    css_class varchar(256) CONSTRAINT required_motion_state_css_class NOT NULL CONSTRAINT enum_motion_state_css_class CHECK (css_class IN ('grey', 'red', 'green', 'lightblue', 'yellow')) DEFAULT 'lightblue',
...
CREATE TABLE organization_t (
    ...
    enable_chat boolean,
    limit_of_meetings integer CONSTRAINT minimum_organization_limit_of_meetings CHECK (limit_of_meetings >= 0) DEFAULT 0,
    limit_of_users integer CONSTRAINT minimum_organization_limit_of_users CHECK (limit_of_users >= 0) DEFAULT 0,
...
CREATE TABLE organization_tag_t (
    ...
    organization_id integer CONSTRAINT required_organization_tag_organization_id NOT NULL DEFAULT 1
);
...
CREATE TABLE poll_t (
    ...
    backend varchar(256) CONSTRAINT required_poll_backend NOT NULL CONSTRAINT enum_poll_backend CHECK (backend IN ('long', 'fast')) DEFAULT 'fast',
    ...
    min_votes_amount integer CONSTRAINT minimum_poll_min_votes_amount CHECK (min_votes_amount >= 1) DEFAULT 1,
    max_votes_amount integer CONSTRAINT minimum_poll_max_votes_amount CHECK (max_votes_amount >= 1) DEFAULT 1,
    max_votes_per_option integer CONSTRAINT minimum_poll_max_votes_per_option CHECK (max_votes_per_option >= 1) DEFAULT 1,
    global_yes boolean DEFAULT False,
    global_no boolean DEFAULT False,
    global_abstain boolean DEFAULT False,
    onehundred_percent_base varchar(256) CONSTRAINT required_poll_onehundred_percent_base NOT NULL CONSTRAINT enum_poll_onehundred_percent_base CHECK (onehundred_percent_base IN ('Y', 'YN', 'YNA', 'N', 'valid', 'cast', 'entitled', 'entitled_present', 'disabled')) DEFAULT 'disabled',
...
CREATE TABLE projector_t (
    ...
    scroll integer CONSTRAINT minimum_projector_scroll CHECK (scroll >= 0) DEFAULT 0,
    width integer CONSTRAINT minimum_projector_width CHECK (width >= 1) DEFAULT 1200,
    aspect_ratio_numerator integer CONSTRAINT minimum_projector_aspect_ratio_numerator CHECK (aspect_ratio_numerator >= 1) DEFAULT 16,
    aspect_ratio_denominator integer CONSTRAINT minimum_projector_aspect_ratio_denominator CHECK (aspect_ratio_denominator >= 1) DEFAULT 9,
...
CREATE TABLE theme_t (
    ...
    organization_id integer CONSTRAINT required_theme_organization_id NOT NULL DEFAULT 1
);
...
CREATE TABLE user_t (
    ...
    email varchar(256),
    default_vote_weight decimal(16,6) CONSTRAINT minimum_user_default_vote_weight CHECK (default_vote_weight >= 0.000001) DEFAULT '1.000000',
    ...
    organization_id integer CONSTRAINT required_user_organization_id NOT NULL DEFAULT 1
);
