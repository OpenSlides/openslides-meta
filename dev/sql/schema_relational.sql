...
-- MODELS_YML_CHECKSUM = '586d851e9f5cb127c18af8d6081c6e2b'
...
CREATE TABLE poll_config_approval_t (
    ...
    onehundred_percent_base varchar(256) NOT NULL CONSTRAINT enum_poll_config_approval_onehundred_percent_base CHECK (onehundred_percent_base IN ('YN', 'valid', 'cast', 'entitled', 'entitled_present', 'disabled'))
);
...
CREATE TABLE poll_config_rating_approval_t (
    ...
    allow_abstain boolean DEFAULT True,
    onehundred_percent_base varchar(256) NOT NULL CONSTRAINT enum_poll_config_rating_approval_onehundred_percent_base CHECK (onehundred_percent_base IN ('YN', 'valid', 'cast', 'entitled', 'entitled_present', 'disabled'))
);
...
CREATE TABLE poll_config_rating_score_t (
    ...
    onehundred_percent_base varchar(256) NOT NULL CONSTRAINT enum_poll_config_rating_score_onehundred_percent_base CHECK (onehundred_percent_base IN ('YN', 'valid', 'cast', 'entitled', 'entitled_present', 'disabled'))
);
