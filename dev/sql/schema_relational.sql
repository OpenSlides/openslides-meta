...
-- MODELS_YML_CHECKSUM = 'ed19989e94d1fd82a9887aa7624a918a'
...
CREATE TABLE meeting_t (
    ...
    language enum_languages DEFAULT 'en',
    ...
    export_pdf_fontsize integer CONSTRAINT minimum_export_pdf_fontsize CHECK (export_pdf_fontsize >= 10) DEFAULT 10,
    ...
    motion_poll_ballot_paper_selection enum_ballot_paper_selection DEFAULT 'CUSTOM_NUMBER',
    ...
    motion_poll_default_onehundred_percent_base enum_onehundred_percent_bases DEFAULT 'YNA',
    motion_poll_default_backend enum_poll_backends DEFAULT 'fast',
    motion_poll_projection_name_order_first enum_meeting_motion_poll_projection_name_order_first NOT NULL DEFAULT 'last_name',
...
This email was generated automatically.',
    ...
    assignment_poll_ballot_paper_selection enum_ballot_paper_selection DEFAULT 'CUSTOM_NUMBER',
    ...
    assignment_poll_default_onehundred_percent_base enum_onehundred_percent_bases DEFAULT 'valid',
    assignment_poll_default_backend enum_poll_backends DEFAULT 'fast',
    ...
    poll_default_onehundred_percent_base enum_onehundred_percent_bases DEFAULT 'YNA',
    poll_default_backend enum_poll_backends DEFAULT 'fast',
...
CREATE TABLE poll_t (
    ...
    backend enum_poll_backends NOT NULL DEFAULT 'fast',
    ...
    onehundred_percent_base enum_onehundred_percent_bases NOT NULL DEFAULT 'disabled',
...
/*   Missing attribute handling for constant, equal_fields, on_delete, maximum, deferred */