...
CREATE CONSTRAINT TRIGGER constant_assignment_candidate_meeting_user_id AFTER UPDATE OF meeting_user_id ON assignment_candidate_t INITIALLY DEFERRED
FOR EACH ROW EXECUTE FUNCTION prevent_updates('assignment_candidate', 'meeting_user_id');
...
CREATE CONSTRAINT TRIGGER constant_chat_message_meeting_user_id AFTER UPDATE OF meeting_user_id ON chat_message_t INITIALLY DEFERRED
FOR EACH ROW EXECUTE FUNCTION prevent_updates('chat_message', 'meeting_user_id');
...
CREATE CONSTRAINT TRIGGER constant_option_content_object_id AFTER UPDATE OF content_object_id ON option_t INITIALLY DEFERRED
FOR EACH ROW EXECUTE FUNCTION prevent_updates('option', 'content_object_id');
...
CREATE CONSTRAINT TRIGGER constant_poll_candidate_user_id AFTER UPDATE OF user_id ON poll_candidate_t INITIALLY DEFERRED
FOR EACH ROW EXECUTE FUNCTION prevent_updates('poll_candidate', 'user_id');
...
CREATE CONSTRAINT TRIGGER constant_speaker_point_of_order AFTER UPDATE OF point_of_order ON speaker_t INITIALLY DEFERRED
FOR EACH ROW EXECUTE FUNCTION prevent_updates('speaker', 'point_of_order');
...
CREATE CONSTRAINT TRIGGER constant_vote_weight AFTER UPDATE OF weight ON vote_t INITIALLY DEFERRED
FOR EACH ROW EXECUTE FUNCTION prevent_updates('vote', 'weight');
